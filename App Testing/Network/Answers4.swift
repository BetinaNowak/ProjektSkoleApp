...
// Get answers for the fourth question
class NetworkServiceAnswers4 {
  static var sharedObj = NetworkServiceAnswers4()
  let answerSession = URLSession.init(configuration: .default)
  let answersUrlPath = URL(string: "http://test-postnord.dk.linux21.curanetserver.dk/api-get-svar.php?id=4")!
